...
- Pass `-SuppressNewAppAlert` to disable the "new app installed" default-assignment prompts by setting the per-user `NoNewAppAlert` policy flag before writing associations.
