...
- Remove explicit deny ACLs for the current user on UserChoice/UserChoiceLatest keys before writing so protected entries cannot block association updates.
